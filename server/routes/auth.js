...
router.post('/forgot-password',        authController.forgotPassword);   // step 1: email → QR + OTP
router.post('/verify-otp',             authController.verifyOTP);        // step 2: code → reset token
router.post('/reset-password',         authController.resetPassword);    // step 3: new password
router.post('/refresh-otp',            authController.refreshOTP);       // refresh QR when timer expires
